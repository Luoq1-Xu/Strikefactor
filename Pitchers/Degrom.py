...
class Degrom(pitcher.Pitcher):
    ...
    def __init__(self, screen, loadfunc) -> None:
        ...
        self.add_pitch_type(self.deGromFB1, "FF1")
        self.add_pitch_type(self.deGromFB2, "FF2")
        self.add_pitch_type(self.deGromSlider, "SL")
    ...
    def deGromFB2(self, simulation_func):
    ...
    def deGromFB3(self, main_simulation):
        sampley = random.uniform(-25,-5)
        samplex = random.uniform(0,20)
        main_simulation(self.release_point, 'jacobdegrom', -0.015, 0.01, samplex, sampley, 370, 'FF')
