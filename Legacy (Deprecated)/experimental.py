...
class Game:
    ...
    def test(self, release_point, pitchername, ax, ay, vx, vy, traveltime, pitchtype):
        ...
        while running:
            ...
            if elapsed_time >= 10 and current_time - starttime > 1100:
                last_time = current_time
                self.last_pitch_information.append(
                    (self.ball[0], self.ball[1], max(11/dist, 4), max(11/dist, 4)) if current_time < starttime + traveltime + 1100 else
                    (self.ball[0], self.ball[1], self.fourseamballsize, self.fourseamballsize)
                    )
            ...
            if ((current_time > starttime + 1100
                ...
                dist = self.ball[2]/301
                if dist > 1:
                    pygame.draw.ellipse(self.screen,(255,255,255),(self.ball[0], self.ball[1],max(11/dist, 4), max(11/dist, 4)))
            ...
            # FOLLOW THROUGH IF NO CONTACT MADE
                ...
                if pitch_results_done == False:
                    ...
                    # Using scikit-learn model to predict in ball is a strike or not
    ...
    def saleSlider(self):
        ...
        self.test(self.SALERELEASEPOINT, 'chrissale', -0.040, 0.04, samplex, sampley, 500, 'SL')
